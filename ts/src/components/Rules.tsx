...
export default function Rules({}: Props) {
    ...
    return (
        <div style={{ width: window.innerWidth }}>
            ...
            <Box style={{ display: 'flex', justifyContent: 'center' }}>
                <Typography
                    style={{ fontWeight: 'bold', color: 'blue', fontSize: 20, marginTop: 5 }}
                >
            ...
            <Box style={{ display: 'flex', justifyContent: 'center' }}>
                <Typography
                    style={{ fontWeight: 'bold', color: '#19a33c', fontSize: 20, marginTop: 5 }}
                >
            ...
            <Box style={{ display: 'flex', justifyContent: 'center' }}>
                <Typography
                    style={{ fontWeight: 'bold', color: 'orange', fontSize: 20, marginTop: 5 }}
                >
            ...
            <Box style={{ display: 'flex', justifyContent: 'center' }}>
                <Typography
                    style={{ fontWeight: 'bold', color: 'purple', fontSize: 20, marginTop: 5 }}
                >
                    Points: If you spin two DIFFERENT parrots, SUM points. If you spin two of the
                    SAME parrot, MULTIPLY points
                </Typography>
            </Box>
            <Box style={{ display: 'flex', justifyContent: 'center' }}>
                <Typography
                    style={{ fontWeight: 'bold', color: 'red', fontSize: 20, marginTop: 5 }}
                >
                    but you lose all your coins for that round if one of the two parrots is a cop or
                    a pirate
                </Typography>
            </Box>
            <Box style={{ display: 'flex', justifyContent: 'center' }}>
