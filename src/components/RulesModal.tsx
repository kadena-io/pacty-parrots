...
const info: {
  ...
  },
  {
    ...
    description:
      "Subsidizing your movie ticket for John Wick 7: Revenge of the Party Parrot",
    payout: "100",
  },
  {
    value: "Nicolas Cage",
    ...
    description:
      "I outbid DiCaprio on some dinosaur skulls, so what's another 200 coins?",
    payout: "200",
  },
  {
    value: "Guy Fieri",
  ...
  return (
    ...
    >
      ...
      <Box style={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          Points: If you spin two DIFFERENT parrots, SUM points. If you spin two
          of the SAME parrot, MULTIPLY points
        </Typography>
      </Box>
      <Box style={{ display: "flex", justifyContent: "center" }}>
        <Typography
        ...
        >
          but you lose all your coins for that round if one of the two parrots
          is a cop or a pirate
        </Typography>
      </Box>
      <Box style={{ display: "flex", justifyContent: "center" }}>
        <Typography
